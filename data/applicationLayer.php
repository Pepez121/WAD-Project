...
function commentFunction(){
	...
	$result= attemptComment($userName,$userEmail,$userComment);
	if ($result["status"] == "SUCCESS"){
		echo json_encode(array("message" => "Comment"));
	}	
	else{
...
function orderUp(){
	...
	$texto = $_POST['texto'];
	$result= insertOrder($userName,$texto);
	if ($result["status"] == "SUCCESS"){
